                            ...
                            >
                                ...
                                >
                                    <div className="w-full md:w-2/5 h-56 md:h-auto relative overflow-hidden">
                                        <img src={facility?.image_url || '/storage/facilities/Wawi-Kadio-Photo-1560840653.jpeg'} alt={facility?.name || 'Fasilitas'} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
